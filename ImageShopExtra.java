 ...
 * for the ImageShopExtra program and allows you to test the behavior of your image algorithms.
 *
...
public class ImageShopExtra extends GraphicsProgram {

	/**********************************************************
	 *                       Starter Code                     *
	 *                      --------------                    *
	 * This code is provided with ImageShop. This particular  *
	...
	private ImageShopAlgorithmsExtra algorithms;
	...
	public void init() {
		addButtons();
		addActionListeners();
		setTitle("ImageShopExtra");
		algorithms = new ImageShopAlgorithmsExtra();
	}
	...
	private void addButtons() {
		...
		add(new JButton("Blue Filter"), WEST);
		add(new JButton("Pink Filter"), WEST);
		add(new JButton("Yellow Filter"), WEST);

		infoLabel = new JLabel("Welcome to ImageShopExtra!");
		add(infoLabel, NORTH);
	...
	public void actionPerformed(ActionEvent e) {
		...
		} else if (command.equals("Blue Filter")) {
			GImage newImage = algorithms.turnBlue(currentImage);
			setImage(newImage);
			infoLabel.setText(command + " filter applied.");
		}else if (command.equals("Pink Filter")) {
			GImage newImage = algorithms.turnPink(currentImage);
			setImage(newImage);
			infoLabel.setText(command + " filter applied.");
		}else if (command.equals("Yellow Filter")) {
			GImage newImage = algorithms.turnYellow(currentImage);
			setImage(newImage);
			infoLabel.setText(command + " filter applied.");
		}else {
